...
int main(int argc, char **argv) {
    ...
    int keyfile = open("/Users/harsha/CLionProjects/encrypt/key2",O_RDWR | O_CREAT | O_TRUNC, S_IRUSR | S_IWUSR);
    ...
    int inputfile = open("/Users/harsha/CLionProjects/encrypt/input2",O_RDWR | O_CREAT | O_TRUNC, S_IRUSR | S_IWUSR);
    write(inputfile,input_data1,24);
    close(inputfile);
    memset(key_file_name,0, FILE_NAME_SIZE);
    memcpy(key_file_name,"/Users/harsha/CLionProjects/encrypt/key2",FILE_NAME_SIZE );
#endif
